...
static PyMethodDef _cffi_methods[] = {
  {"Cryptography_constant_time_bytes_eq", _cffi_f_Cryptography_constant_time_bytes_eq, METH_VARARGS},
  {"_cffi_setup", _cffi_setup, METH_VARARGS},
  {NULL, NULL}    /* Sentinel */
};

PyMODINIT_FUNC
init_Cryptography_cffi_684bb40axf342507b(void)
{
  PyObject *lib;
  lib = Py_InitModule("_Cryptography_cffi_684bb40axf342507b", _cffi_methods);
  if (lib == NULL || 0 < 0)
    return;
  _cffi_init();
  return;
